...
function crossfade(opacity) {
		if (opacity < 100) {
			...
			opacity += 10;
			window.setTimeout("crossfade("+opacity+")", 60); /*   --------------------------------------------------------------------------------THIS CONTROLS SPEED OF THE FADE */
		} else {
			...
			opacity=0;
			window.setTimeout("crossfade("+opacity+")", 4000); /*   --------------------------------------------------------------------THIS CONTROLS HOW LONG EACH IMAGE LASTS */
		}
